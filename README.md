...
I am currently working on a bilingual forum from scratch for a French-Vietnamese association of Pneumology in full JavaScript (React, Redux, Node & Express organized in API Rest, MySQL). It's done from start to finish, from the creation of the graphic charter to the front and back end development.
